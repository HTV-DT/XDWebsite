...
import {TextField, Box, Button, Stack, Grid, Typography } from '@mui/material';
...
const About = () => {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, padding: 2 }}>
            <Typography variant='h6' component={'h6'} >Gửi tin nhắn ngay cho chúng tôi <br/> Khi bạn cần hỗ trợ hoặc có thắc mắc nhé! </Typography>
